...
const CloseSmp = () => {
    ...
    const updateEdate = async () => {
        try {
            const res = await axios.post("/api/update-edate", {
                edate,
                asmp
            })

            if (res.data.success) {
                alert("Edate updated successfuly")
            }
        } catch (error) {
            console.log("Error:", error)
        }
                ...
                <div className="bg-white shadow-2xl rounded-2xl w-full max-w-5xl p-8">
                    ...
                    <div className='md:hidden'>
                        ...
                        <div className='mt-2 text-xl'>
                            ...
                            <button onClick={updateEdate}>Save</button>
                        </div>
                    </div>
